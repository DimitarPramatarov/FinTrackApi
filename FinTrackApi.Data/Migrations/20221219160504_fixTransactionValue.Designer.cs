...
namespace FinTrackApi.Data.Migrations
{
    ...
    [Migration("20221219160504_fixTransactionValue")]
    partial class fixTransactionValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinTrackApi.Data.Models.MoneyTransaction", b =>
                {
                    b.Property<string>("MoneyTransactionId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BalanceId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("MoneyTransactionName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("MoneyTransactionValue")
            ...
            modelBuilder.Entity("FinTrackApi.Data.Models.MoneyTransaction", b =>
                {
                    b.HasOne("FinTrackApi.Data.Models.Balance", "Balance")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinTrackApi.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
